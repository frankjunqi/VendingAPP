...
public class MC_DifferenceReplenishAllAdapter extends BaseAdapter {
    ...
    public MC_DifferenceReplenishAllAdapter(Context context, List<ReplenishmentDetailWrapperData> dataList, ListView lv) {
        if (dataList == null) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = this.inflater.inflate(R.layout.difference_replenishall_item, parent, false);
